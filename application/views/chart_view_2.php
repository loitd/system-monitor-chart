...
<head>
    ...
    function drawChart() {
	  ...
	  var options = {
		  width: 1000,
		  height: 600,
		  title: 'Charging Data Period Statistics',
		  titlePosition: 'out', 
...
<div id="wrapper">
	...
	<form method="post" action="">
		<span>From date: </span><input id="fromDate" type="text" name="fromDate" value="<?php if (!empty($_POST)){echo($_POST['fromDate']);} else {echo date("Y/m/d", time() - 60*60*24);}?>"/><span></span>
		<span>To date: </span><input id="toDate" type="text" name="toDate" value="<?php if (!empty($_POST)){echo($_POST['toDate']);} else {echo date("Y/m/d");}?>"/><span></span>
